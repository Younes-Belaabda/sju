...
<head>
  ...
  <![endif]-->
    <title>تفعيل البريد الالكتروني | هيئة الصحفيين السعوديين </title>
    <link
...
<body
    ...
    <div style="font-family: 'Cairo', sans-serif; mso-line-height-rule: exactly; display: none;">
        تفعيل البريد الالكتروني | هيئة الصحفيين السعوديين</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p class="sm-leading-32"
                                                ...
                                                🏆
                                                نشكرك على تسجيلك معنا، يجب تفعيل بريدك الإلكتروني بالضغط على الزر أدناه
                                                لتبدأ رحلتك في استخدام هيئة الصحفيين السعوديين!
                                            </p>
                                            <table cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <a href="{{ $url }}"
                                                            style="font-family: 'Cairo', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">تفعيل
                                                            الحساب &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
