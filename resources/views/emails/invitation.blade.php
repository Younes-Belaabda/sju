...
<head>
  ...
  <![endif]-->
    <title>دعوتك لحضور {{ $invite->invitate->name }} | هيئة الصحفيين السعوديين ✌</title>
    <link
...
<body
    ...
    <div style="font-family: 'Cairo', sans-serif; mso-line-height-rule: exactly; display: none;">شكراً لمشاركتك
        بالفعالية | هيئة الصحفيين السعوديين</div>
