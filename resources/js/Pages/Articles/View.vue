            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <Link :href="route('articles.index')">{{ __('News') }}</Link>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="options">
                    ...
                    <div class="buttons">
                        ...
                        <a href="#" onclick="page2pdf('newspage')">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 article">
                        <div class="mb-3">
                            <img v-for="image in article.images" :src="image" :alt="article.title" class="img-fluid text-center d-block m-auto mb-3" />
                        </div>
