                ...
                <div class="col app-chat-history bg-body">
                    <div class="chat-history-wrapper">
                        <div class="chat-history-header border-bottom">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex overflow-hidden align-items-center">
                                    ...
                                    <div class="chat-contact-info flex-grow-1 ms-2">{{ __('Technical Support') }}</div>
                                </div>
                                <div class="d-flex align-items-center">
                                    <Link
                                        as="i"
                                        :href="route('admin.branch-issues.toggle', ticket.id)"
                                        method="post"
                        ...
                        <div class="chat-history-footer shadow-sm">
                            <form class="form-send-message d-flex justify-content-between align-items-center" @submit.prevent="form.post(route('admin.branch-issues.message', ticket.id))">
