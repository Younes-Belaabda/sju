...
const form = useForm({
    ...
    qr_margin_top: props.template.qr_margin_top || 0,
    qr_margin_right: props.template.qr_margin_right || 0,
    qr_margin_bottom: props.template.qr_margin_bottom || 0,
    qr_margin_left: props.template.qr_margin_left || 0,
    file: props.template.file || '',
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-12 order-0 order-md-1">
                <!-- Member information -->
                <div class="card mb-4">
                    <h5 class="card-header">{{ __('Edit Template') }}</h5>
                    <div class="card-body">
                        <form
                            @submit.prevent="
                                form.post(route('admin.templates.update', template.id), {
                                    onSuccess: () => ($refs.previewer.src = template.preview),
                                })
                            "
                        >
                            <!-- Name -->
