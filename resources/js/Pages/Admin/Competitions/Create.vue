...
<template>
    <Head :title="__('Create competition')"> </Head>
    <!-- Content -->
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            ...
            <div class="col-12 order-0 order-md-1">
                <!-- Information -->
                <div class="card mb-4">
                    <h5 class="card-header">{{ __('Create competition') }}</h5>
                    <div class="card-body">
                        <form @submit.prevent="form.post(route('admin.competitions.store'))">
                            <!-- Name -->
                            <div class="row">
                            ...
                            <div class="row" v-for="(competition_field, i) in form.competition_fields" :key="i">
                                ...
                                <div class="mb-3 col-12 col-md-2">
                                    ...
                                    <div class="input-group">
                                        <button class="btn btn-link btn-label-danger" @click="form.competition_fields.splice(i, 1)">
