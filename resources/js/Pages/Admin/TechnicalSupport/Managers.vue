...
const filterReq = debounce(() => Inertia.get(route('admin.tickets.managers'), appended.value, { preserveState: true, replace: true }), 500);
watch(
...
const sortBy = (column) => {
    ...
    Inertia.get(route('admin.tickets.managers'), appended.value, { preserveState: true, replace: true });
};
</script>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <h5 class="card-title mb-3">{{ __('Branch managers tickets') }}</h5>
            ...
            <div class="card-datatable table-responsive">
                    ...
                    <div class="col-md-10 mb-1">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column gap-1 mb-3 mb-md-0">
                            <div class="dt-buttons">
                                <a :href="route('admin.tickets.export', 'managers')" type="button" class="dt-button add-new btn btn-label-secondary me-1">
                                    <span>
                ...
                <table class="datatables-users table border-top">
                    <thead>
                        <tr>
                            <th @click.prevent="sortBy('manager')" class="cursor-pointer" :class="{ 'link-primary': filters.order == 'manager' }">{{ __('User') }}</th>
                            <th @click.prevent="sortBy('manager_mobile')" class="cursor-pointer" :class="{ 'link-primary': filters.order == 'manager_mobile' }">{{ __('Mobile') }}</th>
                            ...
                            <td>
                                <div class="d-flex justify-content-start align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <Link :href="route('admin.admins.show', ticket.supportable.id)" class="text-body text-truncate">
