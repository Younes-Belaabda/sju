...
const sortBy = (column) => {
    ...
    Inertia.get(route('admin.tickets.index'), appended.value, { preserveState: true, replace: true });
};
</script>
        ...
        <div class="card">
            ...
            <div class="card-datatable table-responsive">
                    ...
                    <div class="col-md-10 mb-1">
                        <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column gap-1 mb-3 mb-md-0">
                            <div class="dt-buttons">
                                <a :href="route('admin.tickets.export', 'members')" type="button" class="dt-button add-new btn btn-label-secondary me-1">
                                    <span>
                ...
                <table class="datatables-users table border-top">
                    <thead>
                        <tr>
                            <th @click.prevent="sortBy('member')" class="cursor-pointer" :class="{ 'link-primary': filters.order == 'member' }">{{ __('User') }}</th>
                            <th @click.prevent="sortBy('member_mobile')" class="cursor-pointer" :class="{ 'link-primary': filters.order == 'member_mobile' }">{{ __('Mobile') }}</th>
