...
<template>
    <Head :title="__('Employment statement')" />
    <div class="members">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="registration-form">
                        ...
                        <div class="tab-content text-start" id="myTabContent">
                            <div class="tab-pane fade show text-start pt-4 active" role="tabpanel" aria-labelledby="home-tab">
                                <!-- I stopped here! -->
                                <form @submit.prevent="form.post(route('member.profile.statement'))">
                                    <!-- Row -->
                                    <div class="row">
                                        <div class="col-md-8">
                                            <!-- Photo rules -->
                                            ...
                                            <!-- The upload button -->
                                            <div class="mt-4">
                                                <input type="file" class="form-control" @change="form.statement_photo = $event.target.files[0]" v-if="userAuth.status < 1" />
                                                <progress v-if="form.progress" :value="form.progress.percentage" max="100">{{ form.progress.percentage }}%</progress>
                                                <p class="text text-danger text-sm" v-if="form.errors.statement_photo">{{ form.errors.statement_photo }}</p>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <span class="d-block">
                                                <img class="img-fluid" :src="userAuth.statement_photo || '/img/letter.png'" />
                                            </span>
                                        </div>
                                        <!-- preview -->
                                    </div>
