                    ...
                    <div class="registration-form">
                        ...
                        <div class="tab-content text-start" id="myTabContent">
                            <div class="tab-pane fade show text-start pt-4 active" role="tabpanel" aria-labelledby="home-tab">
                                <!-- I stopped here! -->
                                <form @submit.prevent="form.post(route('member.profile.photo'))">
                                    <!-- Row -->
                                    <div class="row">
                                        <div class="col-md-8">
                                            <!-- Photo rules -->
                                            ...
                                            <!-- The upload button -->
                                            <div class="mt-4">
                                                <input type="file" class="form-control" @change="form.profile_photo = $event.target.files[0]" v-if="userAuth.status < 1" />
                                        ...
                                        <div class="col-md-4 text-center">
                                            <span class="d-block">
                                                <img class="img-fluid" :src="userAuth.profile_photo || '/img/user-dark.png'" />
                                            </span>
                                        </div>
                                        <!-- preview -->
                                    </div>
