            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <Link :href="route('courses.index')">{{ __('Courses') }}</Link>
                        </li>
                    </ul>
                </nav>
                <div class="desc">
                    <div class="date">
                        <span class="day">{{ new Date(course.date_from).getDate() }}</span>
                        <span class="month">
                ...
                <div class="options">
                    <div class="buttons">
                        <Link :href="route('courses.register', course.id)" target="_blank">
                        ...
                        <a href="#" onclick="window.print();">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16.412" height="16.412" viewBox="0 0 16.412 16.412">
                                <g id="printer" transform="translate(0)">
                                    ...
                                    <path id="Path_90" data-name="Path 90" d="M12.445,20.684h-4.1a.342.342,0,0,1,0-.684h4.1a.342.342,0,1,1,0,.684Z" transform="translate(-2.529 -6.323)" fill="#fff" />

                                    <path id="Path_91" data-name="Path 91" d="M12.445,18.684h-4.1a.342.342,0,0,1,0-.684h4.1a.342.342,0,1,1,0,.684Z" transform="translate(-2.529 -5.691)" fill="#fff" />

                                    <path id="Path_92" data-name="Path 92" d="M9.71,16.684H8.342a.342.342,0,0,1,0-.684H9.71a.342.342,0,1,1,0,.684Z" transform="translate(-2.529 -5.059)" fill="#fff" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 event-content">
                        <div class="mb-5" v-html="course.content"></div>

                        <div class="signing-form">
                            <h5>{{ __('Additional info') }}</h5>

                            <table class="table table-bordered mb-4">
                                <tbody>
                                    <tr>
                                        <th style="width: 30%">{{ __('Course name') }}</th>
                                        <td>{{ course.title }}</td>
                                    </tr>

                                    <tr>
                                        <th style="width: 30%">{{ __('Course date') }}</th>
                                    ...
                                    <tr>
                                        <th style="width: 30%">{{ __('Course time') }}</th>
                            ...
                            <form method="post" @submit.prevent="form.post(route('courses.attend', course.id))">
                                <table class="table table-bordered mb-4">
                                    <tbody>
                                        <tr v-if="$page.props.userAuth">
                                            <th style="width: 30%">{{ __('User name') }}</th>
                                            <td>{{ $page.props.userAuth?.fullName }}</td>
                                        </tr>
                                        <tr v-if="!$page.props.userAuth">
                                            <th style="width: 30%">{{ __('User name') }}</th>
                                            <td>
                                                <a href="#" onclick="$('#LoginModal').modal('show')" class="btn btn-sm btn-success mx-2">
                                ...
                                <button type="submit" class="btn btn-sm btn-success p-2" v-if="$page.props.userAuth && !attended">{{ __('Attend for the course') }}</button>

                                <div class="alert alert-success alert-lg" v-if="$page.props.userAuth && attended">
                                    <strong>
                                        <i class="far fa-thumbs-up"></i>
                                        {{ __('You are attended to the course') }}
                                    </strong>
                    ...
                    <div class="col-md-4 upcoming-events">
                        <h4>{{ __('Upcoming courses') }}</h4>

                        <!-- Single Event -->
                        <div class="col-12 event" v-for="course in courses.data">
                            <div class="date">
