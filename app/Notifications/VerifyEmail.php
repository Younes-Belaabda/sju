...
class VerifyEmail extends Notification implements ShouldQueue
{
    ...
    protected function verificationUrl($notifiable)
    {
        ...
        $route = 'verification.verify'; // Fallback route
        if ($notifiable instanceof Subscriber) $route = 'subscriber.verification.verify';
        if ($notifiable instanceof Volunteer) $route = 'volunteer.verification.verify';
